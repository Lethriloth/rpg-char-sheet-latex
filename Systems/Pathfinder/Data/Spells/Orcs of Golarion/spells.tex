...
\DeclareSpell{Blood Rage}{enchantment (compulsion) [mind-affecting]|V,  S,  M (a drop of blood from each creature to be affected)|1 standard action|close (25 ft. + 5 ft./level)|Targetsone willing living creature per 2 levels, no two of which may be more than 30 ft. apart|1 round/level|Will negates (harmless)|yes (harmless)}[]
...
\DeclareSpell{Shield the Banner}{abjuration () []|V,  S,  DF|1 standard action|touch|Targetsstandard touched|1 minute/level|Will negates|no}[]
...
\DeclareSpell{Vigor}{transmutation () []|V,  S|1 standard action|touch|Targetscreature touched|1 minute or until discharged|Will negates (harmless)|yes}[]
