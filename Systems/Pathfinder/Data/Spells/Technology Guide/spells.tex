...
\DeclareSpell{Antitech Field}{abjuration|V,  S,  M/DF (pinch of rust)|1 standard action|10 ft.|Targets: 10-ft.-radius emanation centered on you|1 minute/level (D)|Fortitude partial (see text)|yes}[]
    \DeclareSpellDescription{Antitech Field}{You bring into being a mobile, hemispherical energy field that prevents technological objects, signals, and creatures from entering.
...
\DeclareSpell{Destroy Robot}{transmutation|V,  S,  F/DF|1 standard action|close (25 ft. + 5 ft./2 levels)|Targets: one robot (see below)|instantaneous|Fortitude partial|yes}[]
    \DeclareSpellDescription{Destroy Robot}{You attempt to destroy any one robot in range. When you cast this spell, your hand crackles with electricity. You must succeed at a ranged touch attack to affect the target.
...
\DeclareSpell{Memory Of Function}{transmutation|V,  S,  powdered skymetal worth 10, 000 gp|1 standard action|touch|Targets: object or construct touched|instantaneous|Will negates|yes}[]
    \DeclareSpellDescription{Memory Of Function}{Even a broken object remembers what it means to be a functioning whole. You restore a broken object or damaged construct to a functional state, as if it were new and intact.
...
\DeclareSpell{Rebuke Technology}{abjuration|V,  S,  F/DF (powdered fragments of technology)|1 standard action|medium (100 ft. + 10 ft./level)|Targets: one technological object or creature|1 round/level|Fortitude negates (object)|yes (object)}[]
    \DeclareSpellDescription{Rebuke Technology}{You shroud the targeted technological object or creature (such as a robot or a nanotech swarm) with magical energy.
...
\DeclareSpell{Greater Remove Radioactivity}{conjuration (healing)|V,  S|1 standard action|touch|Targets: creature or object touched|instantaneous|Fortitude negates (object)|yes (object)}[]
    \DeclareSpellDescription{Greater Remove Radioactivity}{This spell functions like remove radioactivity, save that it cures all ability damage and drain due to radioactivity that the target has taken. In addition, you can deplete a radioactive object as well, although because you must touch the object to affect it, you expose yourself to at least 1 round of contact with the object's radiation. You must succeed at a caster level check (DC = 5 + the Fortitude DC associated with the radiation effect) in order to deplete the object. If you are successful, the object no longer emits radiation. In the case of a nuclear reactor or atomic warhead, this permanently renders the reactor or warhead inert and harmless.}
        
\DeclareSpell{Technomancy}{divination|V,  S,  M (oil stirred with a coil of wires)|1 standard action|60 ft.|Targets: cone-shaped emanation|3 rounds/level|none|no}[]
    \DeclareSpellDescription{Technomancy}{This spell functions as detect magic, except it detects the presence of technological objects instead of magical objects. The spell grants you the Technologist feat for the purposes of attempting Knowledge (engineering) checks to identify the properties of technological items in your possession. If you already possess this feat, you gain a +10 bonus on Knowledge (engineering) checks to identify item properties.}
