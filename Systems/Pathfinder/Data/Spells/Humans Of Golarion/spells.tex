...
\DeclareSpell{Ablative Sphere}{abjuration|V,  S,  M (a crystalline sphere worth 10 gp)|1 standard action|personal|Targets: you|1 minute per level (D)||}[]
...
\DeclareSpell{Burning Arc}{evocation [fire]|V,  S|1 standard action|close (25 ft. + 5 ft./2 levels)|Targets: one primary target plus one additional target/3 levels  (each of which must be within 15 ft. of the primary target)|instantaneous|Reflex half|yes}[]
...
\DeclareSpell{Snow Shape}{transmutation [water]|V,  S,  M/DF (a miniature shovel)|1 standard action|touch|Targets: snow or snow-sculpted object touched, up to 5 cubic ft.  + 1 cubic ft./level|instantaneous|none|no}[]
...
\DeclareSpell{Summon Totem Creature}{conjuration (summoning)|V,  S,  M/DF (a piece of bone from any one of your totem animals)|10 minutes|close (25 ft. + 5 ft./2 levels)|Effect: one summoned creature|1 hour (D)|none|no}[]
