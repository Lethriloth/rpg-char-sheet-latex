...
\DeclareSpell{Alter River}{transmutation [water]|S,  V,  M (silt from a dry riverbed)|1 standard action|medium (100 ft. + 10 ft./level)|Targets: area of river up to 5 ft. wide/2 levels and 10 ft. long/level|1 minute/level (D)|none|no}[]
...
\DeclareSpell{Detect Metal}{divination|V,  S,  F (a magnetized nail or nugget of ore)|1 standard action|60 ft.|Area: cone-shaped emanation|concentration, up to 1 minute/level (D)|none|no}[]
...
\DeclareSpell{Hanspur's Flotsam Vessel}{conjuration (creation)|V,  S,  M (driftwood branch or river rat's tail)|1 minute|close (25 ft. + 5 ft./2 levels)|Effect: raft large enough for caster and one passenger/2 levels|1 hour/level (D)|none|no}[]
...
\DeclareSpell{Magnetic Field}{abjuration|V,  S|1 standard action|30 ft.|Area: 30-ft.-radius emanation|1 round/2 levels (D)|Reflex negates (object; see text)|yes (object)}[]
...
\DeclareSpell{Resounding Clang}{transmutation|S,  F (bell,  chimes,  gong,  or cymbals)|1 standard action|30 ft.|Area: 30-ft.-radius burst, centered on you|1 round/level|Reflex negates|yes (object)}[]
...
\DeclareSpell{Riversight}{divination (scrying)|V,  S,  F/DF (a smooth river stone)|1 minute|see text|Effect: magical sensor|1 minute/level (D)|none|no}[]
