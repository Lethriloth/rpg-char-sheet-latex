...
\DeclareDocumentCommand{\addAlchemitsClassFeatures}{m}{
	...
	\ifthenelse{#1 > 1}{
		\edef\charAlchemistDiscoveriesList{}
			...
			\DeclareDocumentCommand{\addAlchemistDiscovery}{m}{
	...
	\ifthenelse{#1 > 19}{
		...
		\addClassFeature{Grand Discovery\ifthenelse{\equal{\charGrandDiscovery}{}}{}{: \charGrandDiscovery}}
			...
			\DeclareDocumentCommand{\setGrandDiscovery}{m}{
...
\DeclareDocumentCommand{\addCavalierClassFeatures}{m}{
		...
		\def\charCavalierOrder{Order}
			...
			\DeclareDocumentCommand{\addCavalierOrderAbility}{m}{
				\listadd{\charCavalierOrderAbilitiesList}{##1}
				\addToCounter{charCavalierOrderAbilitiesCount}{-1}
			}
			\DeclareDocumentCommand{\setCavalierOrder}{m}{
