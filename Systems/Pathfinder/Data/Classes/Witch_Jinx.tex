...
\edef\WitchClassSkillsList{}\forcsvlist{\listadd{\WitchClassSkillsList}}{Bluff, CraftOne, CraftTwo, CraftThree, Disguise, Fly, Heal, Intimidate, KnowledgeArcana, KnowledgeHistory, KnowledgeNature, KnowledgePlanes, ProfessionOne, ProfessionTwo, SenseMotive, Spellcraft, UseMagicDevice}
\newcommand{\AddWitchClassFeatures}[1]{
	...
	\AddClassFeature{\CharPatronType Patron}
		\NewDocumentCommand{\AddPatron}{m m}{
			...
			\renewcommand\do[1]{
				\ifthenelse{\value{@i}<\value{@j}}{
					\stepcounter{@i}
					\AddSpell[Witch]{\value{@i}}{####1}
				}{}
			}
			\docsvlist{##2}
		}
	\edef\CharHexList{}
	\AddClassFeature{Spell Awareness}
		\AddConditionalSkillMod{+\domath{\value{CharWitchClassLevelCount} / 2} to Spellcraft to identify spells cast on her}
	...
	\AddClassFeature{Hexes: (DC \arabic{CharHexDCCount})\forlistloop{\\~~~~}{\CharHexList}}
		...
		\gappto{\RunChecks}{%
			...
			\ifthenelse{\value{CharHexCount} < 0}{
				\AddNotice{\domath{-\value{CharHexCount}} too many hexes}
			}{
				\ifthenelse{\value{CharHexCount} > 0}{
					\AddNotice{Choose \arabic{CharHexCount} more hexes}
				}{}}
		}
	\NewDocumentCommand{\AddWitchSpellcasting}{m}{
		\newSpellcasting[(##1 + 1) / 2]{Witch}{##1}{Int}
