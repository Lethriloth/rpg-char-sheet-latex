...
\NewDocumentCommand{\AddWizardClassFeatures}{m O{Universal} O{} O{}}{
	...
	\NewDocumentCommand{\SetWizardFocusSchool}{m}{
		\ifthenelse{\equal{##1}{Universal}}{
			\renewcommand{\CharWizardFocusSchool}{}
			...
			\ifthenelse{\equal{##1}{Abjuration}}{
				\renewcommand{\CharWizardFocusSchool}{Abjuration}
				...
				\renewcommand{\CharWizardFocusSchool}{Conjuration}
				...
				\renewcommand{\CharWizardFocusSchool}{Divination}
				...
				\renewcommand{\CharWizardFocusSchool}{Enchantment}
				...
				\renewcommand{\CharWizardFocusSchool}{Evocation}
				...
				\renewcommand{\CharWizardFocusSchool}{Illusion}
				...
				\renewcommand{\CharWizardFocusSchool}{Necromancy}
				...
				\renewcommand{\CharWizardFocusSchool}{Transmutation}
	...
	\NewDocumentCommand{\AddWizardOppositionSchool}{m}{
		...
		\AddConditionalSkillMod{-4 to Spellcraft to make items involving ##1 spells.}
	...
	\CheckRightNumberSelected{WizardForbiddenSchools}{wizard opposition schools}[AddWizardOppositionSchool]
