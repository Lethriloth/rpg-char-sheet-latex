...
\put(0,0){% Cohort
	\IfBooleanF\CharHasCohort{%
		\renewcommand\sheetboxcolor{gray!20}%
		\color{gray!40}%
	}%
	...
	%\newcommand{\PrintCohortSkill}[1]{\IfSkillDefaultTF[Cohort]{#1}{\color{gray!50}}{\color{black}}\IfBooleanTF\PrintListFirstItem{\let\PrintListFirstItem\BooleanFalse}{, }\cs{Skill#1DisplayName} \PlusMinus{Cohort#1Count}}
	\let\PrintListFirstItem\BooleanTrue
	\put(192,277){%Skills
	...
	\put(192,0){%Equipment and (maybe) notes
		\NewDocumentCommand{\PrintCohortEquipment}{}{}
		\ifdefvoid{\CohortSpellcastingClass}{%Equipment only
			\put(0,0){\exbox(228,189){Equipment?}}
		}{%Equipment and notes
			\put(0,70){\exbox(228,119){Equipment?}}
			\put(0,0){%Notes
