...
\newcommand{\PrintCohortWeapon}[1]{%
	\begin{tabular}[b]{A{15}A{25}A{65}A{45}A{25}A{25}}
	\multicolumn{3}{A{105}}{\itshape \cs{CohortAttack#1Name}} & \cs{CohortAttack#1AttackBonus} & \cs{CohortAttack#1Damage} &\cs{CohortAttack#1Critical} \tabularnewline\hline\\[-16pt]
	\multicolumn{3}{A{105}}{\tiny\scshape ATTACK} &\tiny\scshape  attack Bonus &\tiny\scshape Damage &\tiny\scshape  Critical  \tabularnewline
	\itshape \cs{CohortAttack#1Type} &  \cs{CohortAttack#1Range} & \multicolumn{4}{A{160}}{\cs{CohortAttack#1Notes}}  \tabularnewline\hline\\[-16pt]
	\tiny\scshape Type & \tiny\scshape Range &\multicolumn{4}{A{160}} {\tiny\scshape ammunition \& Notes } \tabularnewline
	\end{tabular}
}
\put(0,355){
	\PrintCohortWeapon{One}
}
\end{picture}